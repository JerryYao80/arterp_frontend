...
export default function EditResourcePage({ params }: EditResourcePageProps) {
  ...
  const [updateResource] = resourceApi.useUpdateResourceMutation();
    ...
    if (resourceData?.data) {
      ...
      reset({
        ...
        lastMaintenanceDate: resource.lastMaintenanceDate
          ? format(new Date(resource.lastMaintenanceDate), 'yyyy-MM-dd')
          : '',
        nextMaintenanceDate: resource.nextMaintenanceDate
          ? format(new Date(resource.nextMaintenanceDate), 'yyyy-MM-dd')
          : '',
      });
    }
  }, [resourceData, reset]);
